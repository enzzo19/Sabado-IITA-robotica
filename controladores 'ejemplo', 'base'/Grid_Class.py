...
def exe_grid():
    grilla = numpy.zeros((50,50))
    print(grilla)
    g = Grid
    g.prints_on_matrix(Grid,g.identify_type(g),grilla,3)
    g.prints_on_matrix(Grid,g.identify_type(g),grilla,4)
    g.prints_on_matrix(Grid,g.identify_type(g),grilla,0)
    g.prints_on_matrix(Grid,g.identify_type(g),grilla,2)
    g.prints_on_matrix(Grid,g.identify_type(g),grilla,5)
    g.prints_on_matrix(Grid,g.identify_type(g),grilla,6)
    g.prints_on_matrix(Grid,g.identify_type(g),grilla,7)
