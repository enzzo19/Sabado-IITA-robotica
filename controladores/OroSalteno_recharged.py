...
def choose_camera_image():
    if camera_der.getImage() == True:
        img = camera_der.getImage()
        victim_detection(img)
        
    elif camera_izq.getImage() == True:
